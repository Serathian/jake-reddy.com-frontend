...
const TermsAndConditions = () => {
  return (
    <div
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Jake-Reddy.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Jake-Reddy, accessible from{' '}
            <a
              href='jake-reddy.com'
      ...
      <ul>
        <li>
          <p>By email: contact@jake-reddy.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href='www.jake-reddy.com/contact'
              rel='external nofollow noopener'
              target='_blank'>
              www.jake-reddy.com/contact
            </a>
          </p>
        </li>
      </ul>
